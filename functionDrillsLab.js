...
bestMovie = title => `${title.toUpperCase()} is the best movie ever!`
...
console.log(eliminator(contestants, loser))
////////////////// PROBLEM 17 ////////////////////
...
console.log(emailCheck("Jon@gmail.com"))
////////////////// PROBLEM 19 ////////////////////
/*
...
function buyFrogs (gold) {
  while (gold >= 3) {
    totalFrogs +=1, gold -= 3
    console.log(`you have ${totalFrogs} frogs and ${gold} gold!`)
  }
}
